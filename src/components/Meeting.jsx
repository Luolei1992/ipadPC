...
export default class Meeting extends React.Component {
    ...
    render(){
        return (
            ...
            <div className="visitRecordWrap" style={{ height: "730px", overflow: "auto", boxSizing: "border-box", border: "2px solid #000" }}>
                <div id="fromHTMLtestdiv" style={{ height: "auto", border: "0 none" }}>
